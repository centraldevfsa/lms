  ...
  <div :class="['dashboard flex min-h-screen', darkMode ? 'bg-gray-900 text-gray-200' : 'bg-gray-100 text-gray-800']">
    ...
    <aside :class="[darkMode ? 'bg-gray-800' : 'bg-white']" class="w-64 shadow-lg">
      <div class="p-6 flex justify-between items-center">
        <h1 class="text-xl font-bold">FSA Dashboard</h1>
    ...
    <main class="flex-1 p-6">
      ...
      <div class="mb-6">
        ...
        <p class="text-gray-500">Aqui estão seus cursos e ferramentas.</p>
      </div>
      ...
      <section class="mb-8">
        ...
        <div class="bg-yellow-100 rounded-lg shadow-md p-4 flex items-center gap-4">
          ...
          <div>
            ...
            <p class="text-sm text-gray-600">Você ganhou uma medalha por completar 50% do curso "Nutrição Funcional".</p>
          </div>
        </div>
      </section>
...
export default {
  ...
  data() {
    return {
      darkMode: JSON.parse(localStorage.getItem("darkMode")) || false, // Persistência do modo
      user: {
        name: "Alessandro Becker",
        progress: 60, // Progresso fictício em porcentagem
        courses: [
          {
            id: 1,
